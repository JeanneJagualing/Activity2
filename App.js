...
export default function App() {
  ...
  return (
    <View style={[styles.container, isDarkMode ? styles.darkBackground : styles.lightBackground]}>
      <Image source={require('./assets/image.jpg')} style={styles.userIcon} />
      <Text style={[styles.userName, isDarkMode ? styles.darkText : styles.lightText]}>Jeanne B. Jagualing</Text>
